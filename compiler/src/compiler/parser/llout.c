...
YY int Yyp32[]={ 13, 0 };
YY int Yyp31[]={ 266, 9, 0 };
YY int Yyp21[]={ 0 };
YY int Yyp20[]={ 263, 530, 5, 0 };
YY int Yyp19[]={ 263, 529, 7, 0 };
YY int Yyp27[]={ 0 };
YY int Yyp26[]={ 258, 265, 0 };
YY int Yyp38[]={ 0 };
YY int Yyp37[]={ 267, 540, 4, 267, 539, 16, 0 };
YY int Yyp36[]={ 267, 538, 7, 11, 0 };
YY int Yyp35[]={ 267, 537, 1, 0 };
YY int Yyp34[]={ 267, 536, 5, 0 };
YY int Yyp33[]={ 267, 535, 7, 0 };
YY int Yyp18[]={ 0 };
YY int Yyp17[]={ 262, 528, 5, 0 };
YY int Yyp16[]={ 262, 527, 7, 0 };
YY int Yyp30[]={ 268, 267, 534, 0 };
YY int Yyp02[]={ 0 };
YY int Yyp01[]={ 14, 513, 0 };
YY int Yyp23[]={ 0 };
YY int Yyp22[]={ 264, 7, 0 };
YY int Yyp25[]={ 0 };
YY int Yyp24[]={ 260, 531, 7, 0 };
YY int Yyp29[]={ 266, 3, 533, 5, 0 };
YY int Yyp28[]={ 266, 3, 532, 7, 0 };
YY int Yyp12[]={ 0 };
YY int Yyp11[]={ 257, 264, 524, 15, 0 };
YY int Yyp10[]={ 257, 2, 0 };
YY int Yyp09[]={ 257, 523, 263, 522, 8, 0 };
YY int Yyp08[]={ 257, 521, 263, 520, 12, 0 };
YY int Yyp07[]={ 257, 519, 263, 518, 6, 0 };
YY int Yyp06[]={ 257, 517, 262, 516, 18, 0 };
YY int Yyp05[]={ 257, 515, 261, 19, 0 };
YY int Yyp04[]={ 257, 514, 1, 20, 0 };
YY int Yyp03[]={ 257, 260, 17, 0 };
YY int Yyp00[]={ 259, 258, 512, 14, 257, 0 };
YY int Yyp15[]={ 0 };
YY int Yyp14[]={ 261, 526, 5, 0 };
YY int Yyp13[]={ 261, 525, 7, 0 };
...
YY YY_TTYPE Yyd1 [] = { 0,
                ...
                -1,  -1,   8,  -1,  12,  11,  -1,   3,   6,   5, 
                 4,  -1};
YY YY_TTYPE Yyd2 [] = {  4, 0,27, 5,26, 7,26, 14,27};
YY YY_TTYPE Yyd3 [] = {  2, 0,2, 14,1};
YY YY_TTYPE Yyd4 [] = { 0,
...
YY YY_TTYPE Yyd11[] = { 0,
                ...
                -1,  -1};
YY YY_TTYPE Yyd12[] = {  2, 9,31, 13,32};
...
/*--------------------------------------------------*/
YY YY_TTYPE yy_next( cur_state, c )
unsigned int   c ;
int            cur_state ;
{
