	...
	int	do_file()
{
	...
	cfg_symbol_table.compute_firsts();
 ...
 void	statistics( FILE *fp )
{
    ...
    */
    ...
    {
	 fprintf (fp, "\n");
	 fprintf (fp, "%4d/%-4d terminals\n",     cfg_symbol_table.cur_term,    NUMTERMS   );
	 fprintf (fp, "%4d/%-4d nonterminals\n",  cfg_symbol_table.cur_nonterm, NUMNONTERMS);
	 fprintf (fp, "%4d/%-4d productions\n",   cfg_symbol_table.num_productions, MAXPROD  );
	 fprintf (fp, "%4d      actions\n",       cfg_symbol_table.cur_act    );
//OX(	 lr_stats(fp );				      	      		      )
    }
